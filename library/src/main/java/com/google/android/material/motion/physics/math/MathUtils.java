...
public final class MathUtils {
   ...
   * <p>
   * Returns true if {@code a} is less than or equal to {@code b}, allowing for {@code epsilon}
   ...
   * <p>
   * Returns true if {@code a} is greater than or equal to {@code b}, allowing for {@code epsilon}
   * error due to limitations in floating point accuracy.
   * <p>
   * Does not handle overflow, underflow, infinity, or NaN.
   */
   ...
   * <p>
   * Returns false if {@code a} is equal to {@code b}, allowing for {@code epsilon} error due to
   * limitations in floating point accuracy.
   * <p>
   * Does not handle overflow, underflow, infinity, or NaN.
   */
